...
class BondSpider(SecuritySpider):
    ...
    xpaths = {
        ...
        'no_of_cur_reg' : "//div[text()='Number of initially registered covered warrants at VSD:']/following-sibling::node()/text()",
        ...
        'pay_method' : "//div[text()='Issuer method:']/following-sibling::node()/text()",
